...
export const MAX_ADMIN_BODY_BYTES = 512 * 1024;
 ...
 * limit. Admin routes pass a larger ceiling because CMS content (a full blog
 * body, a long itinerary) legitimately exceeds the public inquiry limit.
 */
