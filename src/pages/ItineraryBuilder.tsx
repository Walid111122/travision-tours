...
const AVAILABLE_STOPS: Stop[] = [
  { id: '1', title: 'Solar Boat Museum', location: 'Giza', type: 'historical' },
  { id: '2', title: 'Al-Fishawy Café', location: 'Old Cairo', type: 'leisure' },
  { id: '3', title: 'Cave Church of St. Simon', location: 'Mokattam', type: 'hidden' },
  { id: '4', title: 'Grand Egyptian Museum', location: 'Giza', type: 'historical' },
  { id: '5', title: 'Khan el-Khalili Bazaar', location: 'Old Cairo', type: 'cultural' as any },
  { id: '6', title: 'Tomb of Nefertari', location: 'Luxor', type: 'historical' },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-8">
           <div className="glass p-8 rounded-[40px] border border-white/5">
              <h3 className="text-xs uppercase tracking-widest font-black text-egypt-gold mb-8">Points of Resonance</h3>
